				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (getResultCode() != Activity.RESULT_OK) {
							...
							final PendingIntent pendingIntent = PendingIntent.getActivity(mApplicationContext, Activity.RESULT_OK, restartMainActivtyIntent, PendingIntent.FLAG_UPDATE_CURRENT);
